...
<html class="no-js" lang="">
    <head>
        ...
        <title>Auto Repair Minneapolis | South Import Motors</title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
       
        <link rel="stylesheet" href="http://localhost:8888/week2/wordpress/wp-content/themes/week2/style.css">
    </head>
    <body>
        <!--[if lt IE 8]>
        ...
        <header class="blue">
            <div class="row">
                <div class="col-sm-3">
                    <img src="http://localhost:8888/week2/wordpress/wp-content/themes/week2/images/AAA_logo.png">
                </div>
                <div class="col-sm-6">
                    <h1>South Import Motors</h1>
                    <h2>schedule an appointment today (952)888-3805</h2>
                </div>
                <div class="col-sm-3">
                    <img src="http://localhost:8888/week2/wordpress/wp-content/themes/week2/images/BoschServiceLogo.jpg">
                </div>
           </div>
        ...
        <section id="home" class="row">
            <div class="col-md-3">
                <img src="http://localhost:8888/week2/wordpress/wp-content/themes/week2/images/South-Import-Auto-Repair-Front.png">
            </div>
        ...
        <footer>
            ...
            <section id="address" class="blue row">
                <div class="col-md-6">
                    ...
                    <h3>Email</h3>
                    <img src="http://localhost:8888/week2/wordpress/wp-content/themes/week2/images/bbb_logo.png">
                </div>
